...
WHERE o.created_on_dt BETWEEN '1/01/2022 00:00:01' AND '10/15/2022 23:59:59' AND o.type = 1
...
WHERE o.created_on_dt BETWEEN '1/01/2022 00:00:01' AND '10/15/2022 23:59:59' AND o.type = 2 and o.actual_trans_ts IS NOT NULL
